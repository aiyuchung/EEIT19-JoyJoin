				...
				<div class	="mail" id="${msg.msgNo}">
					<div id="ajax_subject">
						<c:if test="${msg.readStatus == 1}">
							<span class="iconify" data-icon="ion:mail-open-outline" data-inline="false"></span><h2>${msg.subject}</h2>
						</c:if>
						<c:if test="${msg.readStatus == 0}">
							<span class="iconify" data-icon="ion:mail-outline" data-inline="false"></span><h2>${msg.subject}</h2>
						</c:if>
					</div>					
