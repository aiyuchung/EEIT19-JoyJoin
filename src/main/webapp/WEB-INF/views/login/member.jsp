...
<body class="homepage">
	...
	<div style="margin:0 auto;width:70vw;height:95vh;background-color:red;padding:10px;position:static;">
		...
		<table style="background-color:cyan;position: relative;right:0;float:right;">
			<tr><td id="memberInfo-btn">基本資料</td></tr>
			<tr><td id="roleInfo-btn">用戶資料</td></tr>
			<tr><td id="tripInfo-btn">參與活動</td></tr>
			<tr><td id="recommend-btn">推薦好友</td></tr>
