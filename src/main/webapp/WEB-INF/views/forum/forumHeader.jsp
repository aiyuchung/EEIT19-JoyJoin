...
<body>
	...
	<form id="backHomeForm" method="get"
		action="<%=request.getContextPath()%>/forum">
		<input type="hidden" id="keyWordInput" name="keyWord"> <input
			type="hidden" id="activeTypeInput" name="type">
	</form>
