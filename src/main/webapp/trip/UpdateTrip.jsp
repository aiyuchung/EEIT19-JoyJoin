...
<table>
	...
	<tr><td>類別</td>
		<td><input type="text" name="tripClass" value="${trip.tripClass}"></td>
	<tr><td>性質</td>
		<td><input type="text" name="tripType" value="${trip.tripType}"></td>
	<tr><td>名稱</td>
		<td><input type="text" name="tripName" value="${trip.tripName}"></td>
	<tr><td>地區</td>
		<td><input type="text" name="tripProv" value="${trip.tripLocation}"></td>
	<tr><td>縣市</td>
		<td><input type="text" name="tripDate" value="${trip.tripProv}"></td>
	<tr><td>日期</td>
		<td><input type="text" name="tripDate" value="${trip.tripDate}"></td>
	<tr><td>費用</td>
		<td><input type="text" name="tripDate" value="${trip.tripFee}"></td>
	<tr>
