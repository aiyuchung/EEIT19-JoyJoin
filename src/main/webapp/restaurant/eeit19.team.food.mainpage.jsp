...
<body>
	<div class="back" style="background-image:url('${pageContext.request.contextPath}/restaurant/img/High.jpg')"></div>
	<div class="view">
		<a href="${pageContext.request.contextPath}/restaurant/eeit19.team.food.insert.jsp" style="float:right">建立活動</a><br>
		<br><span id="back4" style="float:right">全部</span><br>
		<br><input type="button" value="返回" style="float:right;" class="bbb">
		<div class="list">
			<c:forEach var="food" items="${rest}">
				<div style="top: 5px; left: 10px; float: left; width: 48%;">
	...
	<script>
        ...
        $("#back1").on("click", function(){$(".back").css("background-image","url('${pageContext.request.contextPath}/restaurant/img/Party.jpg')");
        window.location.href = "${pageContext.request.contextPath}/TypeSelect_1"})
        $("#back2").on("click", function(){$(".back").css("background-image","url('${pageContext.request.contextPath}/restaurant/img/Date.jpg')");
        window.location.href = "${pageContext.request.contextPath}/TypeSelect_2"})
        $("#back3").on("click", function(){$(".back").css("background-image","url('${pageContext.request.contextPath}/restaurant/img/expensive.jpg')");
        window.location.href = "${pageContext.request.contextPath}/TypeSelect_3"})
        $("#back4").on("click", function(){$(".back").css("background-image","url('${pageContext.request.contextPath}/restaurant/img/High.jpg')");
        window.location.href = "${pageContext.request.contextPath}/Food_SelectAll"})
		
        $(".bbb").on("click",function(){window.location.href = "${pageContext.request.contextPath}/restaurant/eeit19.team.food.EnterPage.jsp"})
	</script>
</body>
</html>