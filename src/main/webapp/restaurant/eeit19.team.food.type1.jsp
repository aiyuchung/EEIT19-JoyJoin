...
<body>
	<div class="back" style="background-image:url('${pageContext.request.contextPath}/restaurant/img/Party.jpg')"></div>
	<div class="view">
		...
		<form class="fselect">
			<fieldset id="L1">
				<legend>行程類型</legend>
				<p id="back1" style="background-color:red;color:white">親友聚餐</p>
				<p id="back2">情侶約會</p>
				<p id="back3">高檔餐廳</p>
			</fieldset>
		</form>
