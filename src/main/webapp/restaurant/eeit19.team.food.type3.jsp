...
<body>
	<div class="back" style="background-image:url('${pageContext.request.contextPath}/restaurant/img/expensive.jpg')"></div>
	<div class="view">
		...
		<form class="fselect">
			<fieldset id="L1">
				...
				<p id="back1">親友聚餐</p>
				<p id="back2">情侶約會</p>
				<p id="back3" style="background-color:red;color:white">高檔餐廳</p>
			</fieldset>
		</form>
	...
	<script>
        ...
        $("#back2").on("click", function(){window.location.href = "${pageContext.request.contextPath}/TypeSelect_2"})
