...
<jsp:useBean  id="cus" scope="request" class="com.web.activity.model.CustomerBean"/>
	<form id="form1" action="../InsertDemo" method="post">
	<table>
		<!-- 	<tr><td>號
	 	<td><input type="text" disabled value="${cus.entityID}">  -->
		...
		<tr><td>出生日期<td><input type="date" name="birthDate" value="${cus.birthDate}">
		...
		<div>
			<input type="submit" name="newempno" value="新增" class="insert" />
			<input type="button" value="回首頁" class="select" >
		</div>
	</table>		
	</form>
